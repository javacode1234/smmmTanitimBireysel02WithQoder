...
async function testAllAPIEndpoints() {
  try {
    ...
    console.log(`✅ POST /api/customers: Customer created with ID ${newCustomer.id}`);
    ...
    // Test 3: GET /api/quote-requests
    console.log('\n3. Testing GET /api/quote-requests...');
    ...
    // Test 4: GET /api/contact-messages
    console.log('\n4. Testing GET /api/contact-messages...');
    ...
    // Test 5: GET /api/job-applications
    console.log('\n5. Testing GET /api/job-applications...');
